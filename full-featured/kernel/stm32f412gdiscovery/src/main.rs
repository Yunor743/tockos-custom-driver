...
struct STM32F412GDiscovery {
    ...
    // Define my drivers here !!
    locker: &'static drivers::locker::Locker<
        'static,
        VirtualMuxAlarm<'static, stm32f412g::tim2::Tim2<'static>>,
    >,
...
impl SyscallDriverLookup for STM32F412GDiscovery {
        ...
        F: FnOnce(Option<&dyn kernel::syscall::SyscallDriver>) -> R,
    {
        match driver_num {
            ...
            // Define my drivers here !!
            drivers::locker::DRIVER_NUM => f(Some(self.locker)),
...
pub unsafe fn main() {
    ...
    // Instantiate my drivers here !!
    let locker_alarm = static_init!(
        VirtualMuxAlarm<'static, stm32f412g::tim2::Tim2<'static>>,
        VirtualMuxAlarm::new(mux_alarm)
    );
    locker_alarm.setup();

    let locker = static_init!(
        drivers::locker::Locker<'static, VirtualMuxAlarm<'static, stm32f412g::tim2::Tim2<'static>>>,
        drivers::locker::Locker::new(
            locker_alarm,
            base_peripherals.gpio_ports.get_pin(stm32f412g::gpio::PinId::PF04).unwrap(), //D3
            base_peripherals.gpio_ports.get_pin(stm32f412g::gpio::PinId::PF10).unwrap(), //D5
            base_peripherals.gpio_ports.get_pin(stm32f412g::gpio::PinId::PF03).unwrap(), //D6
            base_peripherals.gpio_ports.get_pin(stm32f412g::gpio::PinId::PB08).unwrap(), //D9
            base_peripherals.gpio_ports.get_pin(stm32f412g::gpio::PinId::PA15).unwrap(), //D10
            base_peripherals.gpio_ports.get_pin(stm32f412g::gpio::PinId::PA07).unwrap(),  //D11
            base_peripherals.gpio_ports.get_pin(stm32f412g::gpio::PinId::PA06).unwrap(),  //D12
            1234,
        )
    );
    locker_alarm.set_alarm_client(locker);
