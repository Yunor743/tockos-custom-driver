...
struct STM32F412GDiscovery {
    ...
    arithmetic: &'static drivers::arithmetic::Arithmetic,
    logic: &'static drivers::logic::Logic,
...
impl SyscallDriverLookup for STM32F412GDiscovery {
        ...
        F: FnOnce(Option<&dyn kernel::syscall::SyscallDriver>) -> R,
    {
        match driver_num {
            ...
            drivers::arithmetic::DRIVER_NUM => f(Some(self.arithmetic)),
            drivers::logic::DRIVER_NUM => f(Some(self.logic)),
...
pub unsafe fn main() {
    ...
    let arithmetic = static_init!(drivers::arithmetic::Arithmetic, drivers::arithmetic::Arithmetic::new());
    let logic = static_init!(drivers::logic::Logic, drivers::logic::Logic::new());
